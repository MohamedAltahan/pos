                ...
                <div>
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                ...
                                <?php
                                $upload_path = realpath(__DIR__ . '/../../../public/uploads');
                                ?>
                            </td>
                            <td>
                                <?php
                    ...
                    <center>
                        ...
                        <p>
                            <?php
                            if ($all_ok) {
                                echo '<span class="text-success">All setting looks correct. Go to <a href=' . route('install.options') . '>next step</a></span>';
                            } else {
                    ...
                    <div class="col-md-12">
                        ...
                        <br />
                        <p class="text-center">
                            <a href="https://ultimatefosters.com/product/installation-update-service/?ref=install-step1"
                                target="_blank" class="btn btn-default"><i class="fas fa-cogs"></i> Take Installation
                                Service</a>
                        </p>
                        <hr />
                    </div>
